    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="glass-card rounded-2xl p-5">
          ...
          <p className="text-2xl font-bold text-white">{analytics.totalCopied}</p>
          <p className="text-xs text-slate-500 mt-1">Copied</p>
        </div>

        <div className="glass-card rounded-2xl p-5">
          <div className="w-10 h-10 rounded-xl bg-yellow-600/10 flex items-center justify-center mb-3">
            <Zap className="w-5 h-5 text-spark-400" />
          </div>
          <p className="text-2xl font-bold text-white">{analytics.todayCount}</p>
                ...
                <div key={platform}>
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-xs text-slate-300 flex items-center gap-1.5">
                      <span>{getPlatformEmoji(platform as Platform)}</span>
                  ...
                  <div className="h-1.5 rounded-full bg-slate-800">
                    <div
                      className="h-full rounded-full forge-gradient transition-all"
